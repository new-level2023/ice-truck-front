...
const FashionOne = () => {
  ...
  const featuredProducts = getProducts(products, "fashion", "featured", 4);
  const newProducts = getProducts(products, "fashion", "new", 4);
  const bestSellerProducts = getProducts(products, "fashion", "popular", 4);
  const saleProducts = getProducts(products, "fashion", "sale", 4);
