  ...
  return (
    <div className="sidebar">
      ...
      <div className="widget">
        <div className="shop-banner">
          ...
          <div className="shop-bn-content2">
            <h5 className="text-uppercase shop-subtitle">New Items</h5>
      ...
      <div className="widget">
        ...
        <div className="tags">
          <Link href="/blog/grid-left-sidebar">dress</Link>
          <Link href="/blog/grid-left-sidebar">design</Link>
          <Link href="/blog/grid-left-sidebar">branding</Link>
          <Link href="/blog/grid-left-sidebar">electronics</Link>
        </div>
      </div>
    </div>
  );
